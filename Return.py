...
def returnBooks():
    ...
    greet = Label(window, font = ('Segoe UI', 30, 'bold'), text = "Return Books")
    ...
    submitbtn=Button(window,text="Submit",command=return_db,bg="DodgerBlue2",fg="white",font = ('Segoe UI', 15, 'bold'))
