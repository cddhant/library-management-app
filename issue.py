...
def issueBooks():
    ...
    greet = Label(window, font = ('Segoe UI', 30, 'bold'), text = "Issue Books")
    ...
    L = Label(window, font = ('Segoe UI', 15, 'bold'), text = "Enter StudentName: ")
    L.grid(row = 4, column = 1)
 
    L = Label(window, font = ('Segoe UI', 15, 'bold'), text = "   ")
    L.grid(row = 4, column = 2)
 
    StudentName=Entry(window,width=5,font =('Segoe UI', 15, 'bold'))
    StudentName.grid(row=4,column=3)
    
    submitbtn=Button(window,text="Submit",command=issue_db,bg="DodgerBlue2",fg="white",font = ('Segoe UI', 15, 'bold'))
