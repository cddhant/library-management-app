...
def addBooks():
    ...
    greet = Label(window, font = ('Segoe UI', 30, 'bold'), text = "Add Books")
    ...
    L = Label(window, font = ('Segoe UI', 15, 'bold'), text = "Enter Title: ")
    L.grid(row = 4, column = 1)
 
    L = Label(window, font = ('Segoe UI', 15, 'bold'), text = "   ")
    L.grid(row = 4, column = 2)
 
    title=Entry(window,width=5,font =('Segoe UI', 15, 'bold'))
    title.grid(row=4,column=3)
 
    #----------author-------------------
 
    L = Label(window, font = ('Segoe UI', 15, 'bold'), text = "Enter Author: ")
    L.grid(row = 6, column = 1)
 
    L = Label(window, font = ('Segoe UI', 15, 'bold'), text = "   ")
    L.grid(row = 6, column = 2)
 
    author=Entry(window,width=5,font =('Segoe UI', 15, 'bold'))
    author.grid(row=6,column=3)
    
    submitbtn=Button(window,text="Submit",command=add_db,bg="DodgerBlue2",fg="white",font = ('Segoe UI', 15, 'bold'))
